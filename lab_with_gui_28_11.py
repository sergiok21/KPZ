...
class Interpretator(MDScreen):
    ...
    def deploy(self, dt):
        ...
        #                             if self.bl.children[len(self.bl.children) - i].text[j - 1] == " ":
        #                                 if var:
        #                                     print(self.bl.children[len(self.bl.children) - i].text[0:j - 1], "asdasd")
        ...
        #                                             # else:
        #                                             #     var.append(
        #                                             #         self.bl.children[len(self.bl.children) - i].text[j - 1])
        #                                             #     val.append(
        #                                             #         self.bl.children[len(self.bl.children) - i].text[j + 2:len(
        #                                             #             self.bl.children[len(self.bl.children) - i].text)])
        #                                 else:
        ...
        #                     array_print_condition.append(len(array_print_condition) - 1)
        #         else:
        #             if self.add_to_condition is None:
        #                 index = -1
        #                 for m in range(len(var)):
    ...
    def view_interpreter(self, dt):
        ...
        for i in range(1, len(self.bl.children) + 1):
            if "==" in self.bl.children[len(self.bl.children) - i].text:
                ...
                self.add_to_condition = None
        print(condition_eq, condition_min)
        print(var, val)
        print(array_prints, array_print_condition)
        print(var_condition, val_condition)
        # for i in range(1, len(self.bl.children) + 1):
        ...
        #         self.condition_bool_min = False
        #     elif "print" in self.bl.children[len(self.bl.children) - i].text:
        #         if self.bool_condition is None:
        #             print(self.bool_condition)
        #             try:
        #                 print(self.bl.children[len(self.bl.children) - i].text, "check something")
        #                 print(self.iter_for_print, "iter print")
        #                 self.bl2.add_widget(MDLabel(text=("%s%s") % (str(self.tab), str(
        #                     val[array_prints[self.iter_for_print]]))))
        #                 self.iter_for_print += 1
        #             except:
        #                 print("except just print")
        #         else:
        #             if array_print_condition:
        #                 if self.condition_bool_true is True: # if condition is true for ==
        #                     if condition_eq[len(condition_eq) - 1] is True:
        #                         try:
        #                             self.bl2.add_widget(MDLabel(text=("%s%s") % (str(self.tab), str(
        ...
        #                 elif self.condition_bool_min is True:
        #                     if condition_min[len(condition_min) - 1] is True: # if condition is true for <
        #                         try:
        #                             self.bl2.add_widget(
        ...
        #     elif "<" in self.bl.children[len(self.bl.children) - i].text:
        #         if condition_min[len(condition_min) - 1] is True:
        #             self.bool_condition = True
        #             self.condition_bool_true = False
